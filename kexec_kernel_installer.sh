#!/system/bin/sh
#Android Kexecboot kernel Installer - TF700t-AKBI v2.6.5
# 08/26/2014
#by workdowg@xda
...
echo "4 - CROMBi-KK - that11cm11 kernel"
echo "5 - CROMBi-KK - hardslog Grimlock"
echo "6 - CROMBi-KK - stock cm11 kernel"
echo "7 - ZOMBi-X - that10 Omni kernel"
echo "8 - ZOMBi-X - hardslog Omni Grimlock"
echo "9 - ZOMBi-X - stock cm11 kernel"
...
case $kernel_ver in
    ...
    4) cp CROMBi-KK_that11/* /system/boot/ ;;
    5) cp CROMBi-KK_grim/* /system/boot/ ;;
    6) cp CROMBi-KK_Stock/* /system/boot/ ;;
    7) cp thatomni/* /system/boot/ ;;
    8) cp grimomni3/* /system/boot/ ;;
    9) cp cm11boot/* /system/boot/ ;;
